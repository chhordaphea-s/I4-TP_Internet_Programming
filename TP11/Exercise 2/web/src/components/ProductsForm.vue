<template>
  <div class="container-product">
    <div class="header-product">Top One Cambodia</div>
    <div class="box">
      <div class="title">
        <div v-for="i in numofArr" :key="i" style="margin: 0 0 20px 10px">
          <img v-bind:src="titleData.data[parseInt(i - 1)].imageURL" alt="" style="width: 10px" />
          ...
          <div v-for="j in numofItem[parseInt(i - 1)]" :key="j">
            <ul>
              <li style="
                                                                  ...
                                                                  ">
                -
                <router-link @click="subCate(j - 1 + numCate[parseInt(i - 1)])" v-bind:to="
                  '?' +
